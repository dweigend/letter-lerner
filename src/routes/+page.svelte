...
<div class="min-h-screen flex flex-col items-center justify-between p-4 max-w-4xl mx-auto">
    ...
    <main class="flex-1 flex flex-col items-center justify-center w-full gap-8 py-8">
        ...
        <!-- The Emoji -->
        <div class="text-[150px] leading-none filter drop-shadow-xl hover:scale-110 transition-transform duration-300 cursor-default select-none">
            {game.emoji}
        </div>

        <!-- The Word Slots - Simple underscores -->
        <div class="flex flex-wrap gap-4 justify-center">
            {#each game.input as char, i}
                {@const isFilled = char !== ''}
